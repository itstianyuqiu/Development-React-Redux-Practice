# File "PracticeToDoList.js" is a todo list, which uses some core concepts of React (useState, props, useEffect). It allows the user to create/modify/delete a todo list. 
